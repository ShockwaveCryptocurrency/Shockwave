...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Shockwave " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"shockwavetools.com", "dnsseed.shockwavetools.com"},
    {"shockwavepool.org", "dnsseed.shockwavepool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"shockwavetools.com", "testnet-seed.shockwavetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Shockwave is probably already running."), addrBind.ToString().c_str());
        else
